...
class NaiveRoomAlloc(StandardImplications):
    ...
    def room_basic_implications(self):
        for (t, s, g, n, d, p1, r) in list(self.graph['x!tsgndpr'].keys()):
        ...
        for (t, s, g, n, d, p2, r) in list(self.graph['xtsgndpr'].keys()):
            or_list = []
        ...
        for (t, s, g, n, d, p, r) in list(self.graph['x!tsgndpr'].keys()):
            self.graph['x!tsgndpr'][(t, s, g, n, d, p, r)].append(
                ('x!tsgndp', (t, s, g, n, d, p))
            )

        for (t, s, g, n, d, p, r) in list(self.graph['xtsgndpr'].keys()):
            self.graph['xtsgndpr'][(t, s, g, n, d, p, r)].append(
                ('xtsgndp', (t, s, g, n, d, p))
            )

        for (t, d, p, r) in list(self.graph['xtdpr'].keys()):
        ...
        for (t, s, g, n, d, p, r) in list(self.graph['x!tsgndpr'].keys()):
            multi_dict[(t, s, g, n, d, p)].append(
                ('x!tsgndpr', (t, s, g, n, d, p, r)))

        for (t, s, g, n, d, p) in list(multi_dict.keys()):
            self.graph['x!tsgndp'][(t, s, g, n, d, p)].append(
                (StaticVariables.or_head, multi_dict[(t, s, g, n, d, p)]))
        ...
        for (t, d, p) in list(multi_dict.keys()):
            self.graph['xtdp'][(t, d, p)].append(
                (StaticVariables.or_head, multi_dict[(t, d, p)]))
